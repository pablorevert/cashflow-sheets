...
function onOpen() {
  ...
  ui.createMenu('Cashflow')
      ...
      .addSubMenu(ui.createMenu('…… Otras actualizaciones')
                  ...
                  .addItem('🖌 Cashflow Muy Probables c/agrupaciones', 'updateCashflowProbableFull')
                  .addItem('🖌 Cashflow Probables c/agrupaciones', 'updateCashflowSimulatedFull')
                  .addSeparator()
                  .addItem('🖋 Cashflow Confirmados s/agrupaciones', 'updateCashflowConfirmedFast')
                  .addItem('🖋 Cashflow Muy Probables s/agrupaciones', 'updateCashflowProbableFast')
                  .addItem('🖋 Cashflow Probables s/agrupaciones', 'updateCashflowSimulatedFast')
                  )
      .addSeparator()
